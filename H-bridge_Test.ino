...
void loop() {
 ...
 // int distanceR = distCalc(true);
  ...
  if(distanceL<50 and distanceL>35){
    lowRight(); 
  }
  else if(distanceL<35){
    turnRight();
  }
  else{
    straightAhead();
...
void temp2(){
  //if(distanceR<slowTurn and distanceR<fastTurn){

    
 //   while(distanceR<slowTurn){
 //     lowLeft();
  //  }
  //  while(distanceR<slowTurn and distanceR<fastTurn){
   //   turnLeft();
  //  }
 // }

 // if(distanceL<slowTurn){

 //   while(distanceL<slowTurn){
 //     lowRight();
  //  }
 //   while(distanceL<slowTurn and distanceL<fastTurn){
  //    turnRight();
  //  }
//  }
 // else{
